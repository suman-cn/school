			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Batch Session
							<small>Edit Batch Session from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="">Edit Batch Session</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Batch Session</div>
											<div class="tools">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
											...
											<!-- BEGIN FORM-->
											<?= form_open_multipart( '', array('class' => 'horizontal-form'), array('hid_id' => $session->id) ); ?>
                          ...
                          <div class="row-fluid">
                              ...
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              $from_session = explode('/', $session->from );
                                          ?>
                                          <?= form_dropdown('from_month', $month, $from_session[0], array( 'id' => 'from_month', 'class' => 'm-wrap span12' )); ?>
                                      </div>
                                  </div>
                              </div>
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?= form_dropdown('from_year', $year, $from_session[1], array( 'id' => 'from_year', 'class' => 'm-wrap span12' )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="row-fluid">
                              ...
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              $to_session = explode('/', $session->to );
                                          ?>
                                          <?= form_dropdown('to_month', $month, $to_session[0], array( 'id' => 'to_month', 'class' => 'm-wrap span12' )); ?>
                                      </div>
                                  </div>
                              </div>
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?= form_dropdown('to_year', $year, $to_session[1], array( 'id' => 'to_year', 'class' => 'm-wrap span12', 'onchange' => "return onchangeSessionNameSet();" )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                  ...
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              ...
                                              echo form_dropdown('status', $options, $session->status, array( 'class' => 'm-wrap span12' ));
                                          ?>
                                      </div>
                                  </div>
                              </div>
