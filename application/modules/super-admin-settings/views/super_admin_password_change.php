			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Password change
							<small>Password change from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="<?php echo base_url('super-admin-settings/settings/superAdminPasswordChange'); ?>">Password change</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div class="row-fluid">
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Password change</div>
											<div class="tools">
                      ...
                      ?>
                          ...
                          <h3 class="form-section">Password change</h3>
