...
<html lang="en"> <!--<![endif]-->
    ...
    <body class="login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <span style="font-size: 22px; font-weight: bold; color: #ffffff; padding-left: 4px;">Developer </span> <span style="font-size: 22px; font-weight: bold; color: #ff2300;"> Area</span>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright">
            2016 &copy; School management system.
        </div>
        <!-- END COPYRIGHT -->
