			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Exam Type
							<small>Edit Exam Type from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Exam Type</div>
											<div class="tools">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
											...
											<!-- BEGIN FORM-->
											<?= form_open_multipart( '', array('class' => 'horizontal-form'), array('id' => $type->id) ); ?>
                          <h3 class="form-section">Exam Type</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                      ...
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          ...
                                                          'class' => 'm-wrap span12',
                                                          'id' => 'exam_type',
                                                          'value' => $type->exam_type,
                                                        );
                                              echo form_input($attributes);
                                          ?>
                                          <?= form_error( 'exam_type', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Exam Description', 'exam_description', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          ...
                                                          'class' => 'm-wrap span12',
                                                          'id' => 'exam_description',
                                                          'value' => $type->exam_description,
                                                        );
                                              echo form_textarea($attributes);
                                          ?>
                                          <?= form_error( 'exam_description', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
